...
4. **H2: Education and credentials** (dental school, board certifications, continuing education highlights)
...
- Mention the specific dental school.
...
- Include sameAs references to: doctor license verification page (state board for US, provincial college for CA), LinkedIn, and any other verified profile URLs from the brief.
